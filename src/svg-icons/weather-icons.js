...
`;
export const cloudy2NightIcon = html`
...
`;
export const isolatedThunderstormsDayIcon = html`

`;
export const isolatedThunderstormsNightIcon = html`

`;
export const isolatedThunderstormsIcon = html`

`;
export const rainAndSleetMixIcon = html`

`;
export const rainAndSnowMixIcon = html`
...
`;
export const scatteredThunderstormsDayIcon = html`

`;
export const scatteredThunderstormsNightIcon = html`

`;
export const scatteredThunderstormsIcon = html`

`;
export const severeThunderstormIcon = html`

`;
export const snowAndSleetMixIcon = html`

`;
export const snowy1DayIcon = html`

`;
export const snowy1NightIcon = html`

`;
export const snowy1Icon = html`

`;
export const snowy2DayIcon = html`

`;
export const snowy2NightIcon = html`

`;
export const snowy2Icon = html`

`;
export const snowy3DayIcon = html`

`;
export const snowy3NightIcon = html`

`;
export const snowy3Icon = html`
...
`;
export const tornadoIcon = html`

`;
export const tropicalStormIcon = html`

`;
export const weatherIconsIcon = html`
...
<svg viewBox="0 0 48 55" version="1.1" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(16 -2)" filter="url(#blur)">
    <g class="am-weather-wind" transform="translate(-16,10)" fill="none" stroke="#57A0EE" stroke-linecap="round"
      ...
      <path stroke-dasharray="144 16"
        d="M39.5 11A4 4 0 1 1 43 17H6">
        <animate attributeName="stroke-dashoffset" dur="3s" repeatCount="indefinite" values="0; 160" begin="0.5s" />
      </path>
      <path stroke-dasharray="150 10"
        d="M28.5 29A4 4 0 1 0 32 23H15">
        <animate attributeName="stroke-dashoffset" dur="3s" repeatCount="indefinite" values="0; 160" begin="0.25s" />
      </path>
    </g>
  </g>
...
//       <g class="am-weather-moon-star-1"
//         style="-moz-animation-delay:3s;-moz-animation-duration:5s;-moz-animation-iteration-count:1;-moz-animation-name:am-weather-moon-star-1;-moz-animation-timing-function:linear;-ms-animation-delay:3s;-ms-animation-duration:5s;-ms-animation-iteration-count:1;-ms-animation-name:am-weather-moon-star-1;-ms-animation-timing-function:linear;-webkit-animation-delay:3s;-webkit-animation-duration:5s;-webkit-animation-iteration-count:1;-webkit-animation-name:am-weather-moon-star-1;-webkit-animation-timing-function:linear">
//         <polygon points="2.7 4 1.5 3.3 2.7 2.7 3.3 1.5 4 2.7 5.2 3.3 4 4 3.3 5.2" fill="#ffa500"
//           stroke-miterlimit="10" />
//       </g>
//       <g class="am-weather-moon-star-2"
//         style="-moz-animation-delay:5s;-moz-animation-duration:4s;-moz-animation-iteration-count:1;-moz-animation-name:am-weather-moon-star-2;-moz-animation-timing-function:linear;-ms-animation-delay:5s;-ms-animation-duration:4s;-ms-animation-iteration-count:1;-ms-animation-name:am-weather-moon-star-2;-ms-animation-timing-function:linear;-webkit-animation-delay:5s;-webkit-animation-duration:4s;-webkit-animation-iteration-count:1;-webkit-animation-name:am-weather-moon-star-2;-webkit-animation-timing-function:linear">
//         <polygon transform="translate(20,10)" points="2.7 4 1.5 3.3 2.7 2.7 3.3 1.5 4 2.7 5.2 3.3 4 4 3.3 5.2"
//           fill="#ffa500" stroke-miterlimit="10" />
//       </g>
//       <g class="am-weather-moon"
//         style="-moz-animation-duration:6s;-moz-animation-iteration-count:infinite;-moz-animation-name:am-weather-moon;-moz-animation-timing-function:linear;-moz-transform-origin:12.5px 15.15px 0;-ms-animation-duration:6s;-ms-animation-iteration-count:infinite;-ms-animation-name:am-weather-moon;-ms-animation-timing-function:linear;-ms-transform-origin:12.5px 15.15px 0;-webkit-animation-duration:6s;-webkit-animation-iteration-count:infinite;-webkit-animation-name:am-weather-moon;-webkit-animation-timing-function:linear;-webkit-transform-origin:12.5px 15.15px 0">
...
//         fill="#91c0f8" stroke="#fff" stroke-linejoin="round" stroke-width="1.2" />
//     </g>
//     <g class="am-weather-lightning" transform="matrix(1.2,0,0,1.2,-5,28)">
//       <polygon class="am-weather-stroke" points="11.1 6.9 14.3 -2.9 20.5 -2.9 16.4 4.3 20.3 4.3 11.5 14.6 14.9 6.9"
//         fill="#ffa500" stroke="#fff"
//         style="-moz-animation-duration:1.11s;-moz-animation-iteration-count:infinite;-moz-animation-name:am-weather-stroke;-moz-animation-timing-function:linear;-webkit-animation-duration:1.11s;-webkit-animation-iteration-count:infinite;-webkit-animation-name:am-weather-stroke;-webkit-animation-timing-function:linear" />
//     </g>
...
//       </g>
//     </g>
//     <g transform="rotate(10,-198.74,98.01)" fill="none" stroke="#91c0f8" stroke-dasharray="4, 7" stroke-linecap="round"
//       stroke-width="2">
...
//             <path
//                 d="m18.478 0.091701c-0.61699 0.032955-0.87551 0.052836-1.299 0.097701-2.6916 0.28791-5.2645 1.157-7.3542 2.4817-2.0047 1.2706-3.5447 2.9466-4.449 4.8418-0.64953 1.3617-0.97546 2.775-1.0354 4.4867-0.00998 0.2786 0 0.89543 0.017438 1.1266 0.099955 1.3023 0.42346 2.3707 1.0392 3.426 0.10993 0.18887 0.3547 0.56928 0.58202 0.906 0.65079 0.96018 0.79937 1.3128 0.77942 1.8477-0.00998 0.28666-0.078652 0.52701-0.25231 0.88621-0.21106 0.4346-0.47712 0.80964-0.83434 1.1781-0.79685 0.82021-1.9047 1.3921-3.3573 1.7328-0.64575 0.15188-1.5463 0.26543-2.1021 0.26543-0.11371 0-0.20863 0.0053-0.21231 0.01057-0.012494 0.02113 0.76063 0.19684 1.2914 0.29194 0.77942 0.14131 1.4439 0.22182 2.3357 0.28128 0.34966 0.02373 1.8622 0.02373 2.2107 0 1.525-0.10298 2.8066-0.31961 4.1155-0.69734 1.6312-0.47024 3.1775-1.1755 4.4715-2.0393 2.2807-1.5201 3.8832-3.5303 4.6589-5.8443 0.28971-0.86373 0.45213-1.7249 0.53825-2.866 0.02625-0.3394 0.03002-1.1913 0.0076-1.5056-0.09618-1.3287-0.40593-2.3787-1.0117-3.434-0.15245-0.26543-0.36971-0.60484-0.67703-1.0565-0.52701-0.77534-0.70067-1.1636-0.72063-1.6127-0.01501-0.31433 0.05366-0.60224 0.2373-0.98919 0.3947-0.8374 1.0604-1.548 1.9509-2.0802 1.1179-0.66967 2.6817-1.0843 4.3191-1.1438 0.13492-0.005284 0.24485-0.01191 0.24234-0.013254-0.01-0.010567-0.44836-0.11355-0.77187-0.18224-0.70445-0.14919-1.4876-0.26678-2.2033-0.33152-0.592-0.052836-0.81187-0.06206-1.6236-0.066-0.44593-0.0013433-0.84809-0.0013433-0.89312 0.0013433zm-5.9765 9.4961c0.672 0.10299 1.2902 0.53884 1.645 1.1623 0.22733 0.39887 0.33591 0.80955 0.33591 1.2798 0 0.66958-0.23604 1.2732-0.68189 1.7434-0.36099 0.38302-0.79191 0.61415-1.3053 0.69994-0.17609 0.03036-0.52333 0.03036-0.69321 0-0.51829-0.08982-0.94796-0.31961-1.304-0.69466-0.35838-0.37907-0.58328-0.85057-0.66445-1.3987-0.022472-0.1466-0.022472-0.55334 0-0.70003 0.081168-0.54806 0.30724-1.0222 0.66445-1.3986 0.52836-0.55737 1.2528-0.80696 2.0034-0.6934z" />
//         </g>
//     </g>
//     <g class="warning" transform="translate(36,28)">
//       <path
